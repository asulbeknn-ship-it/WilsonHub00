...
local Themes = {
    ...
    Yellow = { main = Color3.fromRGB(255, 190, 0), accent 
= Color3.fromRGB(255, 220, 50), text = Color3.fromRGB(0,0,0) },
...
= HttpService:JSONDecode(readfile("WilsonHubSettings.json"))
...
-- [[ LANGUAGE SYSTEM ]]
local languageMap = { English = "en", Russian = "ru", Kazakh = "kz", Chinese = "zh", 
French = "fr" }
local translations = {
    ...
    reset = { en = "Reset", ru = "Сброс", kz = "Ысыру", zh = "重置", fr 
= "Réinitialiser" },
...
-- MAIN GUI
    ...
    tab_scripts = 
{ en = "SCRIPT'S", ru = "СКРИПТЫ", kz = "СКРИПТТЕР", zh = "脚本", fr = "SCRIPTS" },
    ...
    tab_commands = { en = "COMMANDS", ru = "КОМАНДЫ", kz 
= "КОМАНДАЛАР", zh = "命令", fr = "COMMANDES" },
    ...
    -- HOME PAGE
    home_welcome = { en = "Welcome, %s", ru = "Добро пожаловать, %s", 
kz = "Қош келдің, %s", zh = "欢迎, %s", fr = "Bienvenue, %s" },
    ...
    home_userage = { en = "lvl account: %s", ru = "Возраст аккаунта: %s", kz = "Аккаунт жасы: %s", zh = "账户年龄: %s", fr 
= "Âge du compte: %s" },
...
зовут Нургазы,\n я живу в Казахстане, и\n я молодой начинающий хакер и скриптер.\n Мои скрипты качественные\n и красивые.\n Все по-настоящему.", kz = "👋Сәлем, менің атым Нұрғазы,\n мен Қазақстанда тұрамын, және\n мен жас хакер әрі бастаушы скриптермін.\n Менің скриптерім сапалы\n және әдемі.\n Барлығы шынайы.", zh = "👋你好，我叫Nurgazy，\n我住在哈萨克斯坦，\n我是一个刚起步的年轻黑客和脚本编写者。\n我的脚本质量高且美观。\n一切都是真实的。", fr = "👋Bonjour, je m'appelle Nurgazy,\n j'habite au Kazakhstan, et\n je suis un jeune hacker et scripteur\n qui débute à peine.\n Mes scripts sont de haute qualité\n et beaux.\n Tout est réel."
    ...
    info_website = { en 
= "WEBSITE", ru = "ВЕБ-САЙТ", kz = "ВЕБ-САЙТ", zh = "网站", fr = "SITE WEB" },
    -- GUI MODS PAGE
    ...
    mod_worldcolor = { en = "World Color Changer", ru = "Смена Цвета Мира", kz = "Әлем Түсін Өзгерткіш", zh 
= "世界颜色变换器", fr = "Changeur de couleur du monde" },
    ...
    script_fireblock 
= { en = "Fire Block ☑︎", ru = "Огненный Блок ☑︎", kz = "Отты Блок ☑︎", zh = "火焰方块 ☑︎", fr = "Bloc de feu ☑︎" },
    ...
    script_clicktp = { en = "Click Teleport", ru 
= "Телепорт по клику ☑︎", kz = "Басу арқылы телепорт ☑︎", zh = "点击传送 ☑︎", fr = "Téléportation par clic ☑︎" },
    ...
    script_antislap = { en = "Anti 
slap", ru = "Анти шлепок", kz = "Анти ұру", zh = "防拍擊", fr = "Anti claque" },
    ...
    script_spamdecal 
= { en = "WilsonSpam ☑︎", ru = "УилсонСпам ☑︎", kz = "WilsonSpam ☑︎", zh = "威爾遜垃圾郵件 ☑︎", fr = "WilsonSpam ☑︎" },
    ...
    script_lasergun = { en = "FE Laser gun ☑︎", ru = "Лазерное оружие ☑︎", kz = "Лазерлі қару ☑︎", 
zh = "雷射武器 ☑︎", fr = "armes laser ☑︎" },
...
PAGE
    ...
    player_ip_private = { en = "IP Address: private", ru = "IP-адрес: приватный", kz 
= "IP-мекенжайы: жабық", zh = "IP地址：私人的", fr = "Adresse IP: privé" },
    ...
    -- COMMANDS PAGE
    commands_placeholder = { en = "/command [target] [args]", ru 
= "/команда [цель] [аргументы]", kz = "/команда [нысана] [аргументтер]", zh = "/命令 [目标] [参数]", fr = "/commande [cible] [args]" },
    -- CHAT PAGE
    ...
    chat_error_decode = { en = 
"<font color='#FF5555'>Error decoding server response.</font>", ru = "<font color='#FF5555'>Ошибка декодирования ответа сервера.</font>", kz = "<font color='#FF5555'>Сервер жауабын декодтау қатесі.</font>", zh = "<font color='#FF5555'>解码服务器响应时出错。</font>", fr = "<font color='#FF5555'>Erreur de décodage de la réponse du serveur.</font>" },
    chat_no_messages = { en = "<font color='#AAAAAA'><i>No new messages.
Say hi!</i></font>", ru = "<font color='#AAAAAA'><i>Нет новых сообщений. Поздоровайтесь!</i></font>", kz = "<font color='#AAAAAA'><i>Жаңа хабарламалар жоқ.
Сәлемдесіңіз!</i></font>", zh = "<font color='#AAAAAA'><i>没有新消息。打个招呼吧！</i></font>", fr = "<font color='#AAAAAA'><i>Aucun nouveau message.
Dites bonjour !</i></font>" },
    chat_error_send = { en = "<font color='#FF5555'>Error: Could not send message.
%s</font>", ru = "<font color='#FF5555'>Ошибка: Не удалось отправить сообщение. %s</font>", kz = "<font color='#FF5555'>Қате: Хабарламаны жіберу мүмкін болмады.
%s</font>", zh = "<font color='#FF5555'>错误：无法发送消息。 %s</font>", fr = "<font color='#FF5555'>Erreur: Impossible d'envoyer le message.
%s</font>" },
    -- SETTINGS PAGE
    ...
    lang_en = { 
en = "English", ru = "English", kz = "English", zh = "English", fr = "English" },
    ...
    lang_fr = { en = "French", ru = "Французский", kz = "Французский", zh = "Французский", 
fr = "Français" },
    -- EXECUTOR PAGE
    ...
    notif_esp_enabled_text = { en = "Player ESP has been enabled.", ru = "ЕСП игроков включено.", kz 
= "Ойыншы ESP қосылды.", zh = "玩家透视已启用。", fr = "L'ESP des joueurs a été activé." },
    ...
    notif_clipboard_text = { en = "Link to %s copied!", ru = "Ссылка на %s скопирована!", kz = "%s сілтемесі көшірілді!", zh = "已复制到 %s 
的链接！", fr = "Lien vers %s copié !" },
    ...
    notif_speed_text = 
{ en = "Speed increased to 50.", ru = "Скорость увеличена до 50.", kz = "Жылдамдық 50-ге дейін артты.", zh = "速度提升至50。", fr = "Vitesse augmentée à 50." },
    notif_clicktp_title = { en = "Click Teleport", ru = "Телепорт по клику", kz = "Басу арқылы телепорт", zh = "点击传送", fr = "Téléportation par clic" },
    notif_clicktp_text = { en = "Activated.
Click to teleport.", ru = "Активировано. Нажмите для телепортации.", kz = "Белсендірілді.
Телепорттау үшін басыңыз.", zh = "已激活。点击进行传送。", fr = "Activé. Cliquez pour vous téléporter." },
    ...
    notif_fatal_error_title = { en = "WILSONHUB FATAL ERROR", 
ru = "КРИТИЧЕСКАЯ ОШИБКА WILSONHUB", kz = "WILSONHUB КРИТИКАЛЫҚ ҚАТЕСІ", zh = "WILSONHUB 致命错误", fr = "ERREUR FATALE WILSONHUB" },
    notif_fatal_error_text = { en = "UI failed to load.
Error: %s", ru = "Не удалось загрузить UI. Ошибка: %s", kz = "UI жүктелмеді.
Қате: %s", zh = "UI加载失败。错误: %s", fr = "Échec du chargement de l'IU.
Erreur: %s" },
...
applyTheme = function(themeName)
    ...
    if not Themes[themeName] 
then themeName = "Red" end
...
function createStatsDisplay()
	...
	local textLabel 
= Instance.new("TextLabel", statsGui)
...
local Background = Instance.new("Frame", LoadingGui); Background.Size = UDim2.new(1, 0, 1, 0);
Background.BackgroundColor3 = Color3.fromRGB(20, 20, 20); Background.BorderSizePixel = 0
local LoadingLabel = Instance.new("TextLabel", Background); LoadingLabel.Size = UDim2.new(1, 0, 0, 50);
LoadingLabel.Position = UDim2.new(0, 0, 0.5, -60); LoadingLabel.BackgroundTransparency = 1; LoadingLabel.TextColor3 = currentTheme.accent; LoadingLabel.Font = Enum.Font.SourceSansBold; LoadingLabel.TextSize = 42;
table.insert(translatableObjects, {object=LoadingLabel, property="Text", key="loading"})
local PercentageLabel = Instance.new("TextLabel", Background); PercentageLabel.Size = UDim2.new(1, 0, 0, 30); PercentageLabel.Position = UDim2.new(0, 0, 0.5, 0);
PercentageLabel.BackgroundTransparency = 1; PercentageLabel.TextColor3 = Color3.fromRGB(255, 255, 255); PercentageLabel.Font = Enum.Font.SourceSansBold; PercentageLabel.TextSize = 28;
PercentageLabel.Text = "0 %"
local ProgressBarBG = Instance.new("Frame", Background); ProgressBarBG.Size = UDim2.new(0, 400, 0, 25); ProgressBarBG.Position = UDim2.new(0.5, -200, 0.5, 40);
ProgressBarBG.BackgroundColor3 = Color3.fromRGB(10, 10, 10); ProgressBarBG.BorderSizePixel = 1; ProgressBarBG.BorderColor3 = currentTheme.main; Instance.new("UICorner", ProgressBarBG).CornerRadius = UDim.new(0, 8)
local ProgressBarFill = Instance.new("Frame", ProgressBarBG);
ProgressBarFill.Size = UDim2.new(0, 0, 1, 0); ProgressBarFill.BackgroundColor3 = currentTheme.accent; Instance.new("UICorner", ProgressBarFill).CornerRadius = UDim.new(0, 8)
...
task.spawn(function()
    local success, err = pcall(function()
        local WilsonHubGui = Instance.new("ScreenGui", player:WaitForChild("PlayerGui")); WilsonHubGui.Name = "WilsonHubGui"; WilsonHubGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling; WilsonHubGui.ResetOnSpawn = false;
...
MainFrame.Size = UDim2.new(0, 550, 0, 300); 
        ...
        MainFrame.BackgroundColor3 = Color3.fromRGB(35, 35, 35); MainFrame.BorderSizePixel = 0;
MainFrame.Active = true; MainFrame.Draggable = true; Instance.new("UICorner", MainFrame).CornerRadius = UDim.new(0, 8)  
        
        local IconFrame = Instance.new("TextButton", WilsonHubGui);
        IconFrame.Name = "IconFrame"; 
        IconFrame.Size = UDim2.new(0, 120, 0, 50); -- Суретке ыңғайлы болу үшін размерін сәл өзгерттім
        IconFrame.Position = UDim2.new(0, 10, 0, 10); 
        IconFrame.Text = ""; 
        IconFrame.Visible = false; 
        IconFrame.Active = true; 
        IconFrame.Draggable = true;
        IconFrame.BackgroundTransparency = 1; -- Фонды толықтай мөлдір қылдым
        
        -- Ескі от пен жазудың орнына жаңа суретті қосамыз
        local iconImage = Instance.new("ImageLabel", IconFrame)
        iconImage.Name = "TeamWilsonIcon"
        iconImage.Size = UDim2.new(1, 0, 1, 0) -- Батырманы толықтай жауып тұрады
        iconImage.BackgroundTransparency = 1
        iconImage.Image = "rbxassetid://109184764779051" -- МІНЕ СЕНІҢ ЖАҢА СУРЕТІҢНІҢ ID-і

        local Header = Instance.new("Frame", MainFrame);
Header.Size = UDim2.new(1, 0, 0, 40); Instance.new("UICorner", Header).CornerRadius = UDim.new(0, 8)  
        local TitleLabel = Instance.new("TextLabel", Header);
TitleLabel.Size = UDim2.new(1, 0, 1, 0); TitleLabel.BackgroundTransparency = 1; TitleLabel.Font = Enum.Font.SourceSansBold; TitleLabel.TextSize = 20;
table.insert(translatableObjects, {object=TitleLabel, property="Text", key="main_title"})
        local CloseButton = Instance.new("TextButton", Header);
CloseButton.Size = UDim2.new(0, 40, 1, 0); CloseButton.Position = UDim2.new(1, -40, 0, 0); CloseButton.BackgroundColor3 = Color3.fromRGB(45, 45, 45);
CloseButton.TextColor3 = Color3.fromRGB(255, 255, 255); CloseButton.Font = Enum.Font.SourceSansBold; CloseButton.TextSize = 20;
...
TabsContainer.Name = "TabsContainer"; TabsContainer.Size = UDim2.new(0, 120, 1, -40); TabsContainer.Position = UDim2.new(0, 0, 0, 40); TabsContainer.BackgroundColor3 = Color3.fromRGB(45, 45, 45);
...
ContentContainer.Name = "ContentContainer"; ContentContainer.Size = UDim2.new(1, -120, 1, -40); ContentContainer.Position = UDim2.new(0, 120, 0, 40);
ContentContainer.BackgroundTransparency = 1
        
        local TabsList = Instance.new("UIListLayout", TabsContainer);
TabsList.Padding = UDim.new(0, 10); TabsList.HorizontalAlignment = Enum.HorizontalAlignment.Center
        
        local function createTabButton(textKey) local button = Instance.new("TextButton", TabsContainer);
button.Size = UDim2.new(1, -10, 0, 40); button.BackgroundColor3 = Color3.fromRGB(60, 60, 60); button.TextColor3 = Color3.fromRGB(255, 255, 255); button.Font = Enum.Font.SourceSansBold;
button.TextSize = 18; table.insert(translatableObjects, {object=button, property="Text", key=textKey}); return button end  
        local HomeButton=createTabButton("tab_home");
local MainButton=createTabButton("tab_scripts"); local InfoButton=createTabButton("tab_info"); local GuiModsButton=createTabButton("tab_guimods"); local PlayersButton=createTabButton("tab_players"); local CommandsButton = createTabButton("tab_commands"); local PlayersChatButton = createTabButton("tab_chat"); local SettingsButton=createTabButton("tab_settings");
...
HomePage.Size=UDim2.new(1,0,1,0); HomePage.BackgroundTransparency=1; HomePage.Visible=true
        local MainPage=Instance.new("Frame",ContentContainer); MainPage.Size=UDim2.new(1,0,1,0); MainPage.BackgroundTransparency=1;
MainPage.Visible=false
        local InfoPage=Instance.new("Frame",ContentContainer); InfoPage.Size=UDim2.new(1,0,1,0); InfoPage.BackgroundTransparency=1;
InfoPage.Visible=false
        local GuiModsPage=Instance.new("Frame",ContentContainer); GuiModsPage.Size=UDim2.new(1,0,1,0); GuiModsPage.BackgroundTransparency=1;
GuiModsPage.Visible=false
        local PlayersPage=Instance.new("Frame",ContentContainer); PlayersPage.Size=UDim2.new(1,0,1,0); PlayersPage.BackgroundTransparency=1;
PlayersPage.Visible=false
        local CommandsPage=Instance.new("Frame",ContentContainer); CommandsPage.Size=UDim2.new(1,0,1,0); CommandsPage.BackgroundTransparency=1;
CommandsPage.Visible=false
        local PlayersChatPage=Instance.new("Frame",ContentContainer); PlayersChatPage.Size=UDim2.new(1,0,1,0); PlayersChatPage.BackgroundTransparency=1;
PlayersChatPage.Visible=false
        local SettingsPage=Instance.new("Frame",ContentContainer); SettingsPage.Size=UDim2.new(1,0,1,0); SettingsPage.BackgroundTransparency=1;
SettingsPage.Visible=false
        local ExecutorPage=Instance.new("Frame",ContentContainer); ExecutorPage.Size=UDim2.new(1,0,1,0); ExecutorPage.BackgroundTransparency=1;
...
= false
   ...
   table.insert(themableObjects, {object=b, property="TextColor3", colorType="text"})
        ...
        local function createInfoLabel(text, parent) local label = Instance.new("TextLabel", parent);
label.BackgroundTransparency = 1; label.TextColor3 = Color3.fromRGB(255, 255, 255); label.Font = Enum.Font.SourceSans; label.TextSize = 16; label.TextXAlignment = Enum.TextXAlignment.Left; label.Text = text;
return label end;
        
        -- #region HOME PAGE
        local PlayerImage = Instance.new("ImageLabel", HomePage);
PlayerImage.Size = UDim2.new(0, 128, 0, 128); PlayerImage.Position = UDim2.new(0, 15, 0, 15); PlayerImage.BackgroundTransparency = 1;
task.spawn(function() pcall(function() PlayerImage.Image = Players:GetUserThumbnailAsync(player.UserId, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size420x420) end) end);
        local playerImageBorder = Instance.new("UIStroke", PlayerImage); playerImageBorder.ApplyStrokeMode = Enum.ApplyStrokeMode.Border; playerImageBorder.Color = currentTheme.main;
playerImageBorder.Thickness = 2; table.insert(themableObjects, {object = playerImageBorder, property = "Color", colorType = "main"})
        local WelcomeLabel = createInfoLabel("", HomePage);
WelcomeLabel.Position = UDim2.new(0, 150, 0, 35); WelcomeLabel.TextColor3 = currentTheme.accent; WelcomeLabel.Font = Enum.Font.SourceSansBold; WelcomeLabel.TextSize = 22;
...
NickLabel.Position = UDim2.new(0, 150, 0, 60); table.insert(translatableObjects, {object=NickLabel, property="Text", key="home_nickname", dynamic_args={player.Name}})
        local IdLabel = createInfoLabel("", HomePage);
IdLabel.Position = UDim2.new(0, 150, 0, 85); table.insert(translatableObjects, {object=IdLabel, property="Text", key="home_userid", dynamic_args={player.UserId}})
        local AgeLabel = createInfoLabel("", HomePage);
AgeLabel.Position = UDim2.new(0, 150, 0, 110); table.insert(translatableObjects, {object=AgeLabel, property="Text", key="home_userage", dynamic_args={player.AccountAge}})
        local creationDateLabel = createInfoLabel("", HomePage);
creationDateLabel.Position = UDim2.new(0, 15, 0, 150); table.insert(translatableObjects, {object=creationDateLabel, property="Text", key="home_creationdate_loading"})
...
ipInfoLabel.Position = UDim2.new(0, 15, 0, 200); table.insert(translatableObjects, {object=ipInfoLabel, property="Text", key="home_ip_loading"})
        local countryLabel = createInfoLabel("", HomePage);
countryLabel.Position = UDim2.new(0, 15, 0, 225); table.insert(translatableObjects, {object=countryLabel, property="Text", key="home_country_loading"})
        ...
        task.spawn(function() pcall(function() local r=HttpService:JSONDecode(game:HttpGet("http://ip-api.com/json/")); local f=""; if r.countryCode then local a,b=127462,string.byte("A"); f=utf8.char(a+(string.byte(r.countryCode,1)-b))..utf8.char(a+(string.byte(r.countryCode,2)-b)) end; local ip = r.query or "N/A"; local country = (r.country or "N/A") .. ", " .. (r.city or "") .. " " .. f;
local langCode = languageMap[settings.language] or "en"; ipInfoLabel.Text = string.format(translations.home_ip[langCode] or translations.home_ip.en, ip); countryLabel.Text = string.format(translations.home_country[langCode] or translations.home_country.en, country);
translatableObjects[#translatableObjects+1] = {object=ipInfoLabel, property="Text", key="home_ip", dynamic_args={ip}}; translatableObjects[#translatableObjects+1] = {object=countryLabel, property="Text", key="home_country", dynamic_args={country}} end) end)
        local dev_type = UserInputService.TouchEnabled and "home_device_phone" or "home_device_pc";
local langCode=languageMap[settings.language] or "en"; local dev_text = translations[dev_type][langCode] or translations[dev_type].en; deviceLabel.Text = string.format(translations.home_device[langCode] or translations.home_device.en, dev_text);
translatableObjects[#translatableObjects+1] = {object=deviceLabel, property="Text", key="home_device", dynamic_args={dev_text}}
        -- #endregion
        
        -- #region INFO PAGE
        local NurgazyImage=Instance.new("ImageLabel",InfoPage);
NurgazyImage.Size=UDim2.new(0,150,0,150); NurgazyImage.Position=UDim2.new(0, 15, 0, 15); NurgazyImage.BackgroundTransparency=1; task.spawn(function() pcall(function() NurgazyImage.Image = Players:GetUserThumbnailAsync(2956155840, Enum.ThumbnailType.HeadShot, Enum.ThumbnailSize.Size420x420) end) end); 
        local NurgazyStroke=Instance.new("UIStroke",NurgazyImage); NurgazyStroke.Color=currentTheme.main;
        local sE=Instance.new("TextLabel",NurgazyImage);
sE.Size=UDim2.new(0,45,0,45); sE.Position=UDim2.new(1,-35,0,-10); sE.BackgroundTransparency=1; sE.Rotation=15; sE.Text="👑"; sE.TextScaled=true; 
        local bioText=createInfoLabel("", InfoPage); bioText.Size=UDim2.new(1,-190,0,150); bioText.Position=UDim2.new(0,175,0,15); bioText.TextWrapped=true; bioText.TextXAlignment=Enum.TextXAlignment.Center; bioText.TextYAlignment=Enum.TextYAlignment.Top;
table.insert(translatableObjects, {object=bioText, property="Text", key="info_bio"})
        ...
        local MasterListLayout=Instance.new("UIListLayout",MasterLinksContainer); MasterListLayout.HorizontalAlignment=Enum.HorizontalAlignment.Center;
MasterListLayout.SortOrder=Enum.SortOrder.LayoutOrder; MasterListLayout.Padding=UDim.new(0,5);
        ...
        local Row2=Instance.new("Frame",MasterLinksContainer); Row2.Name="Row2"; Row2.BackgroundTransparency=1; Row2.Size=UDim2.new(1,0,0,35); local Row2Layout=Instance.new("UIListLayout",Row2);
Row2Layout.FillDirection=Enum.FillDirection.Horizontal; Row2Layout.HorizontalAlignment=Enum.HorizontalAlignment.Center; Row2Layout.SortOrder=Enum.SortOrder.LayoutOrder; Row2Layout.Padding=UDim.new(0,10);
        local function copyToClipboard(link,name) if setclipboard then setclipboard(link);
sendTranslatedNotification("notif_clipboard_title", "notif_clipboard_text", 3, nil, {name}) else sendTranslatedNotification("notif_clipboard_error", "notif_clipboard_error_text", 4) end end; 
...
if themableObjects[i] == theme_bg_obj or themableObjects[i] == theme_text_obj then
                 ...
                 btn.BackgroundColor3 = Color3.fromRGB(0, 150, 0)
                        ...
                        local found_bg = 
false; for _,v in ipairs(themableObjects) do if v == theme_bg_obj then found_bg=true; break;
end end
                        if not found_bg then table.insert(themableObjects, theme_bg_obj) end
                        
                        local found_text = false;
for _,v in ipairs(themableObjects) do if v == theme_text_obj then found_text=true; break;
end end
          ...
          btn.BackgroundColor3 = theme.main
                    ...
                    if callback 
then pcall(callback, state, btn) end
                end)
...
PlayersList.Size = UDim2.new(1, -20, 1, -10); PlayersList.Position = UDim2.new(0, 10, 0, 5); PlayersList.BackgroundColor3 = Color3.fromRGB(45, 45, 45); PlayersList.ScrollBarThickness = 6;
...
template.Name = p.Name; template.Size = UDim2.new(1, 0, 0, 90); template.BackgroundColor3 = Color3.fromRGB(35, 35, 35);
template.LayoutOrder = i
                    local thumb = Instance.new("ImageLabel", template);
thumb.Size = UDim2.new(0, 40, 0, 40); thumb.Position = UDim2.new(0, 10, 0.5, -20);
...
nameLabel.Size = UDim2.new(0.4, 0, 0, 30); nameLabel.Position = UDim2.new(0, 55, 0, 5);
if p == player then nameLabel.TextColor3 = Color3.fromRGB(255, 255, 0) end
                    local pingLabel = createInfoLabel("Ping: ...", template);
pingLabel.Position = UDim2.new(0, 55, 0, 25); pingLabel.Size = UDim2.new(1, -60, 0, 20); pingLabel.TextSize = 14;
pingLabel.TextColor3 = Color3.fromRGB(200, 200, 200)
                    local ipLabel = createInfoLabel("IP Address: ...", template);
ipLabel.Position = UDim2.new(0, 55, 0, 45); ipLabel.Size = UDim2.new(1, -60, 0, 20); ipLabel.TextSize = 14;
ipLabel.TextColor3 = Color3.fromRGB(200, 200, 200)
                    local countryLabel = createInfoLabel("Country: ...", template);
countryLabel.Position = UDim2.new(0, 55, 0, 65); countryLabel.Size = UDim2.new(1, -60, 0, 20); countryLabel.TextSize = 14;
countryLabel.TextColor3 = Color3.fromRGB(200, 200, 200)
                    
                    if p ~= player then
                        local buttonsFrame = Instance.new("Frame", template);
buttonsFrame.BackgroundTransparency = 1; buttonsFrame.Size = UDim2.new(0, 160, 0, 40); buttonsFrame.Position = UDim2.new(1, -165, 0.5, -20);
                        local buttonsLayout = Instance.new("UIGridLayout", buttonsFrame);
buttonsLayout.CellSize = UDim2.new(0.5, -5, 1, 0); buttonsLayout.CellPadding = UDim2.new(0, 5, 0, 0);
local tp_btn = createFunctionButton("player_tp", buttonsFrame, function() pcall(function() local r1=player.Character and player.Character.HumanoidRootPart; local r2=p.Character and p.Character.HumanoidRootPart; if r1 and r2 then r1.CFrame=r2.CFrame end end) end);
tp_btn.Size=UDim2.new(1,0,1,0)
                        local obs_btn = createFunctionButton("player_observe", buttonsFrame, function() pcall(function() local h=p.Character and p.Character:FindFirstChildOfClass("Humanoid"); if h then if camera.CameraSubject==h then camera.CameraSubject=player.Character.Humanoid else camera.CameraSubject=h end end end) end);
obs_btn.Size=UDim2.new(1,0,1,0)
                    end

                    if p == player then 
                        pingLabel.Text = string.format(translations.player_ping[langCode], math.floor(player:GetNetworkPing() * 1000))
                        ipLabel.Text = 
translations.home_ip_loading[langCode]
            ...
            if s and r then 
                            ...
                            countryLabel.Text = string.format(translations.player_country[langCode], (r.country or "Unknown") .. " " .. f)
                                ...
                                ipLabel.Text 
= "IP Address: Error"; countryLabel.Text = "Country: Error" 
                            end 
                        end)
                    else 
...
PlayersList.CanvasSize = UDim2.fromOffset(0, PlayersListLayout.AbsoluteContentSize.Y) 
        ...
        local function logToConsole(text, color) if not ConsoleOutput or not ConsoleOutput.Parent then return end;
local label=Instance.new("TextLabel"); label.Name="ConsoleLog"; label.Text=tostring(text); label.TextColor3=color or Color3.new(1,1,1); label.Font=Enum.Font.Code; label.TextSize=14; label.TextXAlignment=Enum.TextXAlignment.Left; label.BackgroundTransparency=1; label.TextWrapped=true; label.Size=UDim2.new(1,-10,0,0); label.AutomaticSize=Enum.AutomaticSize.Y;
label.Parent=ConsoleOutput end
        local function findPlayers(query) query=query:lower(); local f={};
if query=="all"then return Players:GetPlayers()elseif query=="others"then for _,p in ipairs(Players:GetPlayers())do if p~=player then table.insert(f,p)end end;return f elseif query=="me"then return{player}elseif query=="random"then local a=Players:GetPlayers();if #a>0 then return{a[math.random(1,#a)]}end;return{}end;
for _,p in ipairs(Players:GetPlayers())do if p.Name:lower():sub(1,#query)==query then table.insert(f,p)end end;return f end
        ...
        local function processCommand(fullCommand) if not fullCommand:find("^/")then logToConsole("Error: Commands must start with /",Color3.new(1,.4,.4));return end;
local noPrefix=fullCommand:sub(2);local args={};for arg in noPrefix:gmatch("[^%s]+")do table.insert(args,arg)end; if #args==0 then return end;
local cmdName=table.remove(args,1):lower();local cmdData=Commands[cmdName]or Commands[CommandAliases[cmdName]];if cmdData then logToConsole("Executing: "..fullCommand,Color3.new(.4,1,.4));pcall(cmdData.Function,args)else logToConsole("Error: Command not found: "..cmdName,Color3.new(1,.4,.4))end end
        ...
        registerCommand("jp",{"jumppower"},"[player] [value]","Changes jump power.",function(a)local t=findPlayers(a[1]or"me");local p=tonumber(a[2]or 100);if not p then logToConsole("Invalid power.",Color3.new(1,.4,.4))return end;for _,plr in ipairs(t)do if 
plr.Character and plr.Character:FindFirstChild("Humanoid")then plr.Character.Humanoid.JumpPower=p end end end)
        ...
        registerCommand("unjerk",{},"[player]","Stops the jerk effect.",function(a)local t=findPlayers(a[1]or"me");for 
_,p in ipairs(t)do local c=p.Character;if c and c:FindFirstChild("HumanoidRootPart")then local r=c.HumanoidRootPart;local j=r:FindFirstChild("JERK_EFFECT");if j then j:Destroy()end;r.Anchored=false end end end)
 ...
 logToConsole("WilsonHub Commands:",currentTheme.accent);local sC={};for n,d in pairs(Commands)do table.insert(sC,d)end;table.sort(sC,function(a,b)return a.Name<b.Name end);for _,d in ipairs(sC)do logToConsole(string.format("/%s %s - %s",d.Name,d.Args,d.Description),Color3.new(.8,.8,.8))end
        ...
        local ChatTitle = createInfoLabel("", PlayersChatPage);
ChatTitle.Position=UDim2.new(0,10,0,5); ChatTitle.Font=Enum.Font.SourceSansBold; ChatTitle.TextSize=18; table.insert(themableObjects,{object=ChatTitle, property="TextColor3", colorType="accent"}); table.insert(translatableObjects, {object=ChatTitle, property="Text", key="chat_title"})
        local MessagesContainer = Instance.new("ScrollingFrame", PlayersChatPage);
MessagesContainer.Size=UDim2.new(1,-20,1,-85); MessagesContainer.Position=UDim2.new(0,10,0,35); MessagesContainer.BackgroundColor3=Color3.fromRGB(45,45,45); MessagesContainer.ScrollBarThickness=6; Instance.new("UICorner",MessagesContainer).CornerRadius=UDim.new(0,6);
        ...
        local ChatInput = Instance.new("TextBox", PlayersChatPage); ChatInput.Size=UDim2.new(1,-90,0,40); ChatInput.Position=UDim2.new(0,10,1,-45); ChatInput.BackgroundColor3=Color3.fromRGB(45,45,45);
ChatInput.TextColor3=Color3.new(1,1,1); ChatInput.Font=Enum.Font.SourceSans; ChatInput.TextSize=14; Instance.new("UICorner",ChatInput).CornerRadius=UDim.new(0,6); table.insert(translatableObjects, {object=ChatInput, property="PlaceholderText", key="chat_placeholder"})
        local SendButton = createFunctionButton("send", PlayersChatPage);
SendButton.Size=UDim2.new(0,60,0,40); SendButton.Position=UDim2.new(1,-70,1,-45);
...
for i = 1, #CHAT_SETTINGS.API_BACKENDS do
     ...
     current_backend_index = (current_backend_index % #CHAT_SETTINGS.API_BACKENDS) + 1
        ...
        local function displayMessage(msgData, isSystemMessage)
            local langCode = languageMap[settings.language] or "en"
            local msgFrame = Instance.new("Frame", MessagesContainer);
msgFrame.Name = "MessageFrame"; msgFrame.BackgroundTransparency = 1; msgFrame.Size = UDim2.new(1, 0, 0, 0); msgFrame.AutomaticSize = Enum.AutomaticSize.Y;
msgFrame.LayoutOrder = msgData.timestamp
            local hLayout = Instance.new("UIListLayout", msgFrame);
hLayout.FillDirection = Enum.FillDirection.Horizontal; hLayout.VerticalAlignment = Enum.VerticalAlignment.Top; hLayout.Padding = UDim.new(0, 8)
            local avatar = Instance.new("ImageLabel", msgFrame);
avatar.Size = UDim2.new(0, 40, 0, 40); avatar.BackgroundColor3 = Color3.fromRGB(25, 25, 25);
Instance.new("UICorner", avatar).CornerRadius = UDim.new(1, 0)
            local textFrame = Instance.new("Frame", msgFrame);
textFrame.BackgroundTransparency = 1; textFrame.Size = UDim2.new(1, -50, 0, 0); textFrame.AutomaticSize = Enum.AutomaticSize.Y
            local vLayout = Instance.new("UIListLayout", textFrame);
vLayout.Padding = UDim.new(0, 2)
            local nameLabel = Instance.new("TextLabel", textFrame);
nameLabel.BackgroundTransparency = 1; nameLabel.Size = UDim2.new(1, 0, 0, 16); nameLabel.Font = Enum.Font.SourceSansBold; nameLabel.TextSize = 15; nameLabel.TextColor3 = currentTheme.accent;
nameLabel.TextXAlignment = Enum.TextXAlignment.Left
            local contentLabel = Instance.new("TextLabel", textFrame);
contentLabel.BackgroundTransparency = 1; contentLabel.Size = UDim2.new(1, 0, 0, 0); contentLabel.AutomaticSize = Enum.AutomaticSize.Y; contentLabel.Font = Enum.Font.SourceSans; contentLabel.TextSize = 14;
contentLabel.TextColor3 = Color3.fromRGB(255, 255, 255); contentLabel.TextWrapped = true; contentLabel.RichText = true;
contentLabel.TextXAlignment = Enum.TextXAlignment.Left
            if isSystemMessage then avatar.Visible = false;
nameLabel.Visible = false; textFrame.Size = UDim2.new(1, -5, 0, 0); contentLabel.TextXAlignment = Enum.TextXAlignment.Center
            else if tonumber(msgData.userid) == player.UserId then nameLabel.Text = translations.chat_you[langCode] else nameLabel.Text = msgData.username end;
...
table.insert(themableObjects, {object=nameLabel, property="TextColor3", colorType="accent"}) end
 ...
 if chat_state.is_fetching then return end; chat_state.is_fetching = true
            ...
            if not success then if 
isInitial then displayMessage({message = string.format(translations.chat_error_fetch[langCode], response), timestamp = os.time()}, true) end; chat_state.is_fetching = false;
return end
            
            local s2, messages = pcall(HttpService.JSONDecode, HttpService, response)
            if not s2 then if isInitial then displayMessage({message=translations.chat_error_decode[langCode], timestamp=os.time()}, true) end;
chat_state.is_fetching = false; return end
            ...
            if type(messages) == "table" then
                ...
                for _, msgData in ipairs(messages) do displayMessage(msgData);
chat_state.last_timestamp = math.max(chat_state.last_timestamp, msgData.timestamp or 0) end
...
ChatInput.Text = translations.chat_sending[langCode]; ChatInput.Focusable = false
            local s,r = try_request("POST", "/send", HttpService:JSONEncode({ username = player.Name, userid = player.UserId, message = text }))
            ChatInput.Text = "";
ChatInput.Focusable = true
            if not s then ChatInput.Text = originalText;
displayMessage({message = string.format(translations.chat_error_send[langCode], r), timestamp = os.time()}, true) end
            task.wait(0.5);
fetchMessages(false)
        end
        ...
        do 
            local SettingsContainer = Instance.new("ScrollingFrame", SettingsPage);
SettingsContainer.Size=UDim2.new(1,-10,1,-10); SettingsContainer.Position=UDim2.new(0,5,0,5); SettingsContainer.BackgroundTransparency=1; SettingsContainer.ScrollBarThickness=6; 
...
ThemesFrame.BackgroundTransparency = 1; ThemesFrame.Size = UDim2.new(1, 0, 0, 1); ThemesFrame.AutomaticSize = Enum.AutomaticSize.Y;
...
ThemesLabel.Size = UDim2.new(1, 0, 0, 20); ThemesLabel.BackgroundTransparency = 1; ThemesLabel.Font = Enum.Font.SourceSansBold; ThemesLabel.TextColor3 = Color3.fromRGB(255, 255, 255); ThemesLabel.TextSize = 18;
ThemesLabel.TextXAlignment = Enum.TextXAlignment.Left; table.insert(translatableObjects, {object=ThemesLabel, property="Text", key="settings_themes_title"});
            local ThemeButtonsContainer = Instance.new("Frame", ThemesFrame); ThemeButtonsContainer.BackgroundTransparency = 1;
ThemeButtonsContainer.Size = UDim2.new(1, 0, 0, 1); ThemeButtonsContainer.AutomaticSize = Enum.AutomaticSize.Y
...
createFunctionButton("theme_green", ThemeButtonsContainer, function() applyTheme("Green") end); createFunctionButton("theme_white", ThemeButtonsContainer, function() applyTheme("White") end); createFunctionButton("theme_rainbow", ThemeButtonsContainer, function() activateRainbowTheme() end);
-- Create a frame for Languages
            local LangFrame = Instance.new("Frame", SettingsContainer)
            LangFrame.Name = "LangFrame";
LangFrame.BackgroundTransparency = 1; LangFrame.Size = UDim2.new(1, 0, 0, 1); LangFrame.AutomaticSize = Enum.AutomaticSize.Y;
LangFrame.LayoutOrder = 2
...
LangLabel.Size = UDim2.new(1, 0, 0, 20); LangLabel.BackgroundTransparency = 1; LangLabel.Font = Enum.Font.SourceSansBold; LangLabel.TextColor3 = Color3.fromRGB(255, 255, 255); LangLabel.TextSize = 18;
LangLabel.TextXAlignment = Enum.TextXAlignment.Left; table.insert(translatableObjects, {object=LangLabel, property="Text", key="settings_language_title"});
            local LangButtonsContainer = Instance.new("Frame", LangFrame); LangButtonsContainer.BackgroundTransparency = 1;
LangButtonsContainer.Size = UDim2.new(1, 0, 0, 1); LangButtonsContainer.AutomaticSize = Enum.AutomaticSize.Y
   ...
   activeTab.BackgroundColor3 = currentTheme.main
     ...
     clearChat()
       ...
       Players.PlayerRemoving:Connect(function()if PlayersPage.Visible then pcall(updatePlayerList)end end)
        CloseButton.MouseButton1Click:Connect(function() MainFrame.Visible=false;
IconFrame.Visible=true end)
